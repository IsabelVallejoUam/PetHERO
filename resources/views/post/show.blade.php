    ...
    <div class="card">
        ...
        <div class="btn-group" role="group" aria-label="Link options">
            ...
            <form action="{{ route('post.destroy', $post->id) }}" method="post"
                ...
                @csrf
                @method('delete')
                <button type="submit" class="btn btn-danger" title="Remover"><i class="fa fa-trash-alt"></i>Eliminar post</button>  
            </form>
            <a href="{{ route('post.edit', ['post' => $post->id]) }}" class=" btn btn-warning" title="Editar"><i class="fa fa-edit"></i> Editar</a>
        </div>
        @endif
    </div>
